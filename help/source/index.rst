...
:Author/Company: Put your name or company name here---this information is used in writing the copyright statement in the source files of your plugin, as well as being displayed in the Plugin Installer and on the `QGIS plugin repository <http://plugins.qgis.org/plugins>`_.
...
* Linux: ``.qgis/python/plugins`` in your home directory, typically found at
    ``/home/gsherman/.qgis/python/plugins``

* Mac OS X: ``.qgis/python/plugins`` in your home directory, typically
      ``/Users/gsherman/.qgis/python/plugins``

* Windows: ``%HOMEPATH%\.qgis\python\plugins``, by default,
...
Using the Makefile
==================
The make file can be used to compile and deploy your plugin, assuming you are using an operating environment that supports `GNU make <http://gnu.org/software/make>`_. It also provides a number of other actions to aid in plugin development.
