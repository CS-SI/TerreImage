...
class Ui_ValueWidgetBase(object):
    def setupUi(self, ValueWidgetBase):
        ...
        ValueWidgetBase.resize(925, 497)
        self.gridLayout = QtGui.QGridLayout(ValueWidgetBase)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.groupBox_saved_layers = QtGui.QGroupBox(ValueWidgetBase)
        self.groupBox_saved_layers.setObjectName(_fromUtf8("groupBox_saved_layers"))
        self.verticalLayout_3 = QtGui.QVBoxLayout(self.groupBox_saved_layers)
        ...
        self.checkBox_hide_current = QtGui.QCheckBox(ValueWidgetBase)
        self.checkBox_hide_current.setObjectName(_fromUtf8("checkBox_hide_current"))
        self.horizontalLayout.addWidget(self.checkBox_hide_current)
        self.pushButton_get_point = QtGui.QPushButton(ValueWidgetBase)
        self.pushButton_get_point.setObjectName(_fromUtf8("pushButton_get_point"))
        self.horizontalLayout.addWidget(self.pushButton_get_point)
        ...
        self.gridLayout.addWidget(self.graphControls, 1, 1, 1, 1)
    ...
    def retranslateUi(self, ValueWidgetBase):
        ...
        self.checkBox_hide_current.setText(QtGui.QApplication.translate("ValueWidgetBase", "Cacher courbe pixel courant", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_get_point.setText(QtGui.QApplication.translate("ValueWidgetBase", "Obtenir point", None, QtGui.QApplication.UnicodeUTF8))
        ...
        item.setText(QtGui.QApplication.translate("ValueWidgetBase", "Couche", None, QtGui.QApplication.UnicodeUTF8))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(QtGui.QApplication.translate("ValueWidgetBase", "Valeur", None, QtGui.QApplication.UnicodeUTF8))
